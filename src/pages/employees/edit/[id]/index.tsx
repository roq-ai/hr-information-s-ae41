      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        {isLoading || (!formik.values && !error) ? (
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <FormControl id="benefits" mb="4" isInvalid={!!formik.errors?.benefits}>
              <FormLabel>Benefits</FormLabel>
              <Input type="text" name="benefits" value={formik.values?.benefits} onChange={formik.handleChange} />
              {formik.errors.benefits && <FormErrorMessage>{formik.errors?.benefits}</FormErrorMessage>}
            </FormControl>
